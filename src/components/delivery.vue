<template>
  <div class="delivery-history">
    <h3 class="deliver-history-text">Delivery Orders</h3>
    <div class="delivery-wrapper">
      ...
      >
        ...
        <div>
          Address: <span class="bold-text">{{ order.address }}</span>
        </div>
        <div>
        ...
        <div>
          Delivery Company:
          <span class="bold-text">{{ order.deliveryCompany }}</span>
        </div>
        <div>
        ...
        <div>
          ...
          <span class="bold-text"
            >{{ order.estimatedDeliveryTime }} minutes</span
          >
        </div>
        <div>
